...
/**
 * Checks only the connection fields owned by the selected remote type.
 * Values left over from another provider do not make the selected provider configured.
 */
