export const _allMessages = {
    ...
    "moduleMigration.optionSetupViaP2P": {
        ...
        es: "Usar %{short_p2p_sync} para configurar",
        fr: "Utiliser %{short_p2p_sync} pour configurer",
        ja: "%{short_p2p_sync}を使ってセットアップ",
        ko: "%{short_p2p_sync}를 사용하여 설정",
        ru: "Настроить через %{short_p2p_sync}",
        zh: "使用 %{short_p2p_sync} 进行设置",
        "zh-tw": "使用 %{short_p2p_sync} 進行設定",
    },
    ...
    "P2P.DisabledButNeed": {
        ...
        es: "%{title_p2p_sync} está deshabilitado. ¿Realmente quieres habilitarlo?",
        fr: "%{title_p2p_sync} est désactivé. Voulez-vous vraiment l'activer ?",
        ja: "%{title_p2p_sync}は無効になっています。本当に有効にしますか？",
        ko: "%{title_p2p_sync}가 비활성화되어 있습니다. 정말로 활성화하시겠습니까?",
        ru: "%{title_p2p_sync} отключён. Вы действительно хотите включить его?",
        zh: "%{title_p2p_sync} 已禁用。你确定要启用它吗？",
        "zh-tw": "%{title_p2p_sync} 已禁用。你確定要啟用它嗎？",
    },
    "P2P.FailedToOpen": {
    ...
    "P2P.NoAutoSyncPeers": {
        ...
        es: "No se encontraron pares de sincronización automática. Configure pares en el panel %{long_p2p_sync}.",
        fr: "Aucun pair de synchronisation automatique trouvé. Veuillez définir des pairs dans le panneau %{long_p2p_sync}.",
        ja: "自動同期ピアが見つかりません。%{long_p2p_sync}ペインでピアを設定してください。",
        ko: "자동 동기화 피어를 찾을 수 없습니다. %{long_p2p_sync} 창에서 피어를 설정해 주세요.",
        ru: "Устройства для автосинхронизации не найдены. Укажите их на панели %{long_p2p_sync}.",
        zh: "未找到自动同步的对等方，请在 %{long_p2p_sync} 面板中设置对等方",
        "zh-tw": "未找到自動同步的對等方，請在 %{long_p2p_sync} 面板中設定對等方",
    },
    "P2P.NoKnownPeers": {
    ...
    "P2P.NotEnabled": {
        ...
        es: "%{title_p2p_sync} no está habilitado. No podemos abrir una nueva conexión.",
        fr: "%{title_p2p_sync} n'est pas activé. Nous ne pouvons pas ouvrir de nouvelle connexion.",
        ...
        zh: "%{title_p2p_sync} 未启用，无法建立新连接。",
        "zh-tw": "%{title_p2p_sync} 未啟用，無法建立新連線。",
    },
    "P2P.P2PReplication": {
        def: "%{P2P} Replication",
        de: "%{P2P}-Replikation",
