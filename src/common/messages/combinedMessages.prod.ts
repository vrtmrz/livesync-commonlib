export const allMessages = {
    ...
    ", please select the option that best describes the current state of your Vault. The application will then check your files in the most appropriate way based on your selection.":
        {
            ...
            es: ", selecciona la opción que mejor describa el estado actual de tu bóveda. La aplicación comprobará tus archivos de la forma más adecuada según tu selección.",
        },
    "(Active)": {
        def: "(Active)",
        es: "(Activo)",
    ...
    "(Danger) Save Only Settings": {
        ...
        es: "(Peligro) Guardar solo los ajustes",
    ...
    "(e.g., after editing many files whilst offline)": {
        ...
        es: "(p. ej., tras editar muchos archivos estando fuera de línea)",
    },
    "(e.g., immediately after restoring on another computer, or having recovered from a backup)": {
        ...
        es: "(p. ej., justo después de restaurar en otro equipo, o tras recuperar una copia de seguridad)",
    },
    "(e.g., setting up for the first time on a new smartphone, starting from a clean slate)": {
        ...
        es: "(p. ej., configurando por primera vez en un smartphone nuevo, partiendo de cero)",
    },
    ...
    "%{title_p2p_sync} is disabled. Do you really want to enable it?": {
    ...
    "%{title_p2p_sync} is not enabled. We cannot open a new connection.": {
    ...
    "⚠ CORS Origin is unmatched ${from}->${to}": {
    ...
    "⚠️ Please Confirm the Following": {
        ...
        es: "⚠️ Por favor, confirma lo siguiente",
    },
    ...
    "✔ chttpd_auth.require_valid_user is ok.": {
    ...
    "✔ chttpd.max_http_request_size is ok.": {
    ...
    "✔ chttpd.require_valid_user is ok.": {
    ...
    "✔ couchdb.max_document_size is ok.": {
    ...
    "❗ chttpd_auth.require_valid_user is wrong.": {
    ...
    "❗ chttpd.max_http_request_size is low)": {
    ...
    "❗ chttpd.require_valid_user is wrong.": {
    ...
    "❗ couchdb.max_document_size is low)": {
    ...
    "❗ httpd.WWW-Authenticate is missing": {
    ...
    "${count} issue(s) detected!": {
        ...
        es: "¡Se detectaron ${count} problema(s)!",
    },
    "2GB (Standard)": {
        def: "2GB (Standard)",
        es: "2GB (Estándar)",
    ...
    "Additional safety scan completed": {
    ...
    "Additional safety scan has failed on a module": {
    ...
    "After restarting, the data on this device will be uploaded to the server as the 'master copy'. Please be aware that any unintended data currently on the server will be completely overwritten.":
        {
            ...
            es: "Tras reiniciar, los datos de este dispositivo se subirán al servidor como la 'copia maestra'. Ten en cuenta que cualquier dato no deseado que haya actualmente en el servidor será sobrescrito por completo.",
        },
    "After restarting, the database on this device will be rebuilt using data from the server. If there are any unsynchronised files in this vault, conflicts may occur with the server data.":
        {
            ...
            es: "Tras reiniciar, la base de datos de este dispositivo se reconstruirá usando los datos del servidor. Si hay archivos sin sincronizar en esta bóveda, pueden producirse conflictos con los datos del servidor.",
        },
    "After that, synchronise to a brand new vault on each other device with the new remote one by one.": {
        ...
        es: "Después, sincroniza con una bóveda completamente nueva en cada uno de los demás dispositivos con el nuevo remoto, uno por uno.",
    },
    "All checks passed successfully!": {
        def: "All checks passed successfully!",
        es: "¡Todas las comprobaciones se superaron correctamente!",
    },
    ...
    "Also, please note that if you are using Peer-to-Peer synchronization, this configuration will be used when you switch to other methods and connect to a remote server in the future.":
        {
            ...
            es: "Además, ten en cuenta que si estás usando la sincronización Punto a Punto, esta configuración se usará cuando cambies a otros métodos y te conectes a un servidor remoto en el futuro.",
        },
    ...
    "Apply settings to this device, and fetch again": {
    ...
    "Apply settings to this device, but and ignore incompatibility": {
    ...
    "Attention! A local database rebuild is required to apply this!": {
    ...
    "Attention! A rebuild is required to apply this!": {
    ...
    "Before LiveSync, start OneShot once...": {
    ...
    "Broken files has been detected": {
    ...
    "by resetting the remote, you will be informed on other devices.": {
        ...
        es: "al restablecer el remoto, se te informará en los demás dispositivos.",
    },
    Cancel: {
        def: "Cancel",
        es: "Cancelar",
    ...
    "Changing the encryption algorithm will prevent access to any data previously encrypted with a different algorithm. Ensure that all your devices are configured to use the same algorithm to maintain access to your data.":
        {
            ...
            es: "Cambiar el algoritmo de cifrado impedirá el acceso a cualquier dato cifrado previamente con un algoritmo distinto. Asegúrate de que todos tus dispositivos estén configurados para usar el mismo algoritmo y así mantener el acceso a tus datos.",
        },
    ...
    "Checking connection... Please wait.": {
        ...
        es: "Comprobando la conexión... Por favor, espera.",
    },
    ...
    "Configured synchronization mode: DISABLED": {
    ...
    "CouchDB Configuration: ${title} -> Set ${key} to ${value}": {
    ...
    "CouchDB Configuration: ${title} failed": {
    ...
    "CouchDB Configuration: ${title} successfully updated": {
    ...
    "Could not connect to ${uri}:${dbRet}": {
    ...
    "Could not mark resolve remote database.": {
    ...
    "Database cleaning up is in process. replication has been cancelled": {
    ...
    "Delete old metadata of deleted files on start-up": {
        ...
        es: "Eliminar metadatos antiguos al iniciar",
    ...
    "Detect and Fix CouchDB Issues": {
        ...
        es: "Detectar y corregir problemas de CouchDB",
    },
    "Detected Peers": {
        def: "Detected Peers",
        es: "Pares detectados",
    },
    "Detects non optimal settings. (Same as during migration)": {
    ...
    'Device name to identify the device. Please use shorter one for the stable peer detection, i.e., "iphone-16" or "macbook-2021".':
        {
            ...
            es: 'Nombre de dispositivo para identificarlo. Usa uno corto para una detección de pares estable, p. ej., "iphone-16" o "macbook-2021".',
        },
    "Device Peer ID": {
        def: "Device Peer ID",
    ...
    "Discard existing settings and databases": {
        ...
        es: "Descartar los ajustes y bases de datos existentes",
    ...
    "Do not keep metadata of deleted files.": {
        ...
        es: "No conservar metadatos de archivos eliminados.",
    ...
    "Do you really want to discard existing settings and databases?": {
        ...
        es: "¿Realmente deseas descartar los ajustes y bases de datos existentes?",
    ...
    "Enable Hidden files sync": {
        ...
        es: "Habilitar la sincronización de archivos ocultos",
    ...
    "Enabling end-to-end encryption ensures that your data is encrypted on your device before being sent to the remote server. This means that even if someone gains access to the server, they won't be able to read your data without the passphrase. Make sure to remember your passphrase, as it will be required to decrypt your data on other devices.":
        {
            def: "Enabling end-to-end encryption ensures that your data is encrypted on your device before being sent to the remote server. This means that even if someone gains access to the server, they won't be able to read your data without the passphrase. Make sure to remember your passphrase, as it will be required to decrypt your data on other devices.",
            es: "Habilitar el cifrado de extremo a extremo garantiza que tus datos se cifren en tu dispositivo antes de enviarse al servidor remoto. Esto significa que, aunque alguien acceda al servidor, no podrá leer tus datos sin la frase de contraseña. Asegúrate de recordarla, ya que se necesitará para descifrar tus datos en otros dispositivos.",
        },
    ...
    "Enter your Region (e.g., us-east-1, auto for R2)": {
        ...
        es: "Introduce tu región (p. ej., us-east-1, auto para R2)",
    },
    ...
    "Error during testAndFixSettings: ${error}": {
        def: "Error during testAndFixSettings: ${error}",
        es: "Error durante testAndFixSettings: ${error}",
    },
    ...
    "Failed to connect to other peers: ${error}": {
    ...
    "Failed to parse Setup-URI.": {
        ...
        es: "No se pudo analizar la URI de configuración.",
    },
    ...
    "For HS256/HS512 algorithms, provide the shared secret key. For ES256/ES512 algorithms, provide the pkcs8 PEM-formatted private key.":
        {
            ...
            es: "Para los algoritmos HS256/HS512, proporciona la clave secreta compartida. Para los algoritmos ES256/ES512, proporciona la clave privada en formato PEM pkcs8.",
        },
    ...
    "Furthermore, if conflicts are already present in the server data, they will be synchronised to this device as they are, and you will need to resolve them locally.":
        {
            ...
            es: "Además, si ya existen conflictos en los datos del servidor, se sincronizarán a este dispositivo tal cual, y tendrás que resolverlos localmente.",
        },
    ...
    "I already rebuilt the remote. Fetch from the remote": {
    ...
    "I am setting up a new server for the first time / I want to reset my existing server.": {
        ...
        es: "Estoy configurando un servidor nuevo por primera vez / quiero restablecer mi servidor existente.",
    },
    ...
    "I have fixed it, and do not ask again": {
    ...
    "I understand that all changes made on other smartphones or computers possibly could be lost.": {
        ...
        es: "Entiendo que todos los cambios realizados en otros smartphones u ordenadores podrían perderse.",
    },
    "I understand that other devices will no longer be able to synchronise, and will need to be reset the synchronisation information.":
        {
            ...
            es: "Entiendo que los demás dispositivos ya no podrán sincronizar y necesitarán que se restablezca su información de sincronización.",
        },
    ...
    "I understand the risks and will proceed without a backup.": {
        ...
        es: "Entiendo los riesgos y continuaré sin una copia de seguridad.",
    },
    ...
    'If "Auto Broadcast Changes" is enabled, changes will be automatically broadcasted to connected peers without requiring manual intervention. This requests peers to fetch this device\'s changes.':
        {
            ...
            es: 'Si "Difundir cambios automáticamente" está habilitado, los cambios se difundirán automáticamente a los pares conectados sin necesitar intervención manual. Esto solicita a los pares que obtengan los cambios de este dispositivo.',
        },
    'If "Auto Start P2P Connection" is enabled, the P2P connection will be started automatically when the plug-in launches.':
        {
            ...
            es: 'Si "Iniciar conexión P2P automáticamente" está habilitado, la conexión P2P se iniciará automáticamente cuando se inicie el complemento.',
        },
    ...
    "If you cannot avoid CORS issues, you might want to try this option. It uses Obsidian's internal API to communicate with the CouchDB server. Not compliant with web standards, but works. Note that this might break in future Obsidian versions.":
        {
            ...
            es: "Si no puedes evitar los problemas de CORS, puede que quieras probar esta opción. Usa la API interna de Obsidian para comunicarse con el servidor CouchDB. No cumple con los estándares web, pero funciona. Ten en cuenta que esto podría dejar de funcionar en futuras versiones de Obsidian.",
        },
    "If you cannot avoid CORS issues, you might want to try this option. It uses Obsidian's internal API to communicate with the S3 server. Not compliant with web standards, but works. Note that this might break in future Obsidian versions.":
        {
            ...
            es: "Si no puedes evitar los problemas de CORS, puede que quieras probar esta opción. Usa la API interna de Obsidian para comunicarse con el servidor S3. No cumple con los estándares web, pero funciona. Ten en cuenta que esto podría dejar de funcionar en futuras versiones de Obsidian.",
        },
    "If you have unsynchronised changes in your Vault on this device, they will likely diverge from the server's versions after the reset. This may result in a large number of file conflicts.":
        {
            ...
            es: "Si tienes cambios sin sincronizar en tu bóveda en este dispositivo, probablemente divergirán de las versiones del servidor tras el restablecimiento. Esto puede provocar un gran número de conflictos de archivos.",
        },
    ...
    "If you understand the risks and still wish to proceed, select so.": {
        ...
        es: "Si entiendes los riesgos y aun así deseas continuar, indícalo seleccionando esta opción.",
    },
    "If you want to store the data in a specific folder within the bucket, you can specify a folder prefix here. Otherwise, leave it blank to store data at the root of the bucket.":
        {
            ...
            es: "Si quieres almacenar los datos en una carpeta específica dentro del bucket, puedes especificar aquí un prefijo de carpeta. De lo contrario, déjalo en blanco para almacenar los datos en la raíz del bucket.",
        },
    "If you want to use `LiveSync`, you should broadcast changes. All `watching` peers which detects this will start the replication for fetching.":
        {
            ...
            es: "Si quieres usar `LiveSync`, debes difundir los cambios. Todos los pares en modo `watching` que lo detecten iniciarán la replicación para obtenerlos.",
        },
    ...
    "In most cases, you should stick with the default algorithm (${algorithm}), This setting is only required if you have an existing Vault encrypted in a different format.":
        {
            ...
            es: "En la mayoría de los casos, deberías mantener el algoritmo predeterminado (${algorithm}). Este ajuste solo es necesario si tienes una bóveda existente cifrada en un formato diferente.",
        },
    "In this scenario, Self-hosted LiveSync will recreate metadata for every file and deliberately generate conflicts. Where the file content is identical, these conflicts will be resolved automatically.":
        {
            ...
            es: "En este escenario, Self-hosted LiveSync recreará los metadatos de cada archivo y generará conflictos deliberadamente. Cuando el contenido del archivo sea idéntico, estos conflictos se resolverán automáticamente.",
        },
    "Incoming:": {
        def: "Incoming:",
        es: "Entrantes:",
    },
    "increase to ${newMax}MB": {
    ...
    "instead of a CouchDB/S3 server — P2P requires no server setup at all.": {
        def: "instead of a CouchDB/S3 server — P2P requires no server setup at all.",
        es: "en lugar de un servidor CouchDB/S3 — P2P no requiere ninguna configuración de servidor.",
    },
    "Interval (sec)": {
        def: "Interval (sec)",
    ...
    "JWT (JSON Web Token) authentication allows you to securely authenticate with the CouchDB server using tokens. Ensure that your CouchDB server is configured to accept JWTs and that the provided key and settings match the server's configuration. Incidentally, I have not verified it very thoroughly.":
        {
            ...
            es: "La autenticación JWT (JSON Web Token) te permite autenticarte de forma segura con el servidor CouchDB usando tokens. Asegúrate de que tu servidor CouchDB esté configurado para aceptar JWT y de que la clave y los ajustes proporcionados coincidan con la configuración del servidor. Por cierto, no lo he verificado muy exhaustivamente.",
        },
    "JWT Algorithm": {
        def: "JWT Algorithm",
        es: "Algoritmo JWT",
    ...
    "JWT Expiration Duration (minutes)": {
        ...
        es: "Duración de expiración del JWT (minutos)",
    },
    "JWT Key": {
        def: "JWT Key",
        es: "Clave JWT",
    ...
    "Live-push to peers": {
        def: "Live-push to peers",
        es: "Envío en vivo a pares",
    },
    LiveSync: {
        def: "LiveSync",
    ...
    "LiveSync has updated, please read the changelog!": {
    ...
    "Lock remote database to prevent data corruption": {
    ...
    "Mostly Complete: Decision Required": {
        ...
        es: "Casi completo: se requiere una decisión",
    },
    "Move remotely deleted files to the trash, instead of deleting.": {
        ...
        es: "Mover los archivos eliminados remotamente a la papelera, en lugar de eliminarlos.",
    ...
    "No auto-sync peers found. Please set peers on the %{long_p2p_sync} pane.": {
    ...
    "No checks have been performed yet.": {
        ...
        es: "Aún no se ha realizado ninguna comprobación.",
    },
    ...
    "No peers has been detected, waiting incoming other peers...": {
    ...
    "No replicator is available, this is the fatal error.": {
    ...
    "No, and do not ask again until the next release": {
    ...
    "Note that the Group ID is not limited to the generated format; you can use any string as the Group ID.": {
        ...
        es: "Ten en cuenta que el ID de grupo no está limitado al formato generado; puedes usar cualquier cadena de texto como ID de grupo.",
    },
    'Note that you can generate a new Setup URI by running the "Copy settings as a new Setup URI" command in the command palette.':
        {
            ...
            es: 'Ten en cuenta que puedes generar una nueva URI de configuración ejecutando el comando "Copiar los ajustes como una nueva URI de configuración" en la paleta de comandos.',
        },
    Notification: {
        def: "Notification",
        es: "Notificación",
    ...
    "Obfuscating properties (e.g., path of file, size, creation and modification dates) adds an additional layer of security by making it harder to identify the structure and names of your files and folders on the remote server. This helps protect your privacy and makes it more difficult for unauthorized users to infer information about your data.":
        {
            ...
            es: "Ofuscar propiedades (p. ej., la ruta del archivo, el tamaño, las fechas de creación y modificación) añade una capa adicional de seguridad al dificultar la identificación de la estructura y los nombres de tus archivos y carpetas en el servidor remoto. Esto ayuda a proteger tu privacidad y dificulta que usuarios no autorizados infieran información sobre tus datos.",
        },
    "Obsidian version": {
    ...
    "obsidianLiveSyncSettingTab.msgSettingsUnchangeableDuringSync": {
        ...
        es: 'Estos ajustes no se pueden cambiar durante la sincronización. Por favor, desactiva toda la sincronización en "Ajustes de sincronización" para desbloquear.',
    ...
    "On the source device, from the command palette, run the 'Show settings as a QR code' command.": {
        ...
        es: "En el dispositivo de origen, desde la paleta de comandos, ejecuta el comando 'Mostrar los ajustes como un código QR'.",
    },
    ...
    "On this device, please keep this Vault open.": {
        ...
        es: "En este dispositivo, mantén abierta esta bóveda.",
    },
    "On this device, switch to the camera app or use a QR code scanner to scan the displayed QR code.": {
        ...
        es: "En este dispositivo, cambia a la app de cámara o usa un lector de códigos QR para escanear el código QR mostrado.",
    },
    "OneShot Sync begin... (${syncMode})": {
    ...
    "P2P (Peer-to-Peer) synchronisation": {
        def: "P2P (Peer-to-Peer) synchronisation",
        es: "sincronización P2P (Punto a Punto)",
    },
    "P2P Configuration": {
    ...
    "P2P Remote (${roomSuffix})": {
        def: "P2P Remote (${roomSuffix})",
        es: "Remoto P2P (${roomSuffix})",
    },
    "P2P Status": {
        def: "P2P Status",
        es: "Estado P2P",
    ...
    "P2P Sync with ${name} have been started.": {
    ...
    "Passphrase is required.": {
        ...
        es: "Se requiere una frase de contraseña.",
    },
    ...
    "Peer ${name} seems offline, skipped.": {
    ...
    "Perfect for setting up a new device!": {
    ...
    "Please enter the CouchDB server information below.": {
        ...
        es: "Introduce a continuación la información del servidor CouchDB.",
    },
    "Please enter the details required to connect to your S3/MinIO/R2 compatible object storage service.": {
        ...
        es: "Introduce los datos necesarios para conectar con tu servicio de almacenamiento de objetos compatible con S3/MinIO/R2.",
    },
    "Please enter the Peer-to-Peer Synchronisation information below.": {
        ...
        es: "Introduce a continuación la información de sincronización Punto a Punto.",
    },
    "Please enter the Setup URI that was generated during server installation or on another device, along with the vault passphrase.":
        {
            ...
            es: "Introduce la URI de configuración generada durante la instalación del servidor o en otro dispositivo, junto con la frase de contraseña de la bóveda.",
        },
    "Please follow the steps below to import settings from your existing device.": {
        ...
        es: "Sigue los pasos a continuación para importar los ajustes desde tu dispositivo existente.",
    },
    "PLEASE NOTE": {
        def: "PLEASE NOTE",
        es: "TEN EN CUENTA",
    ...
    "Please select an active P2P remote configuration to change P2P sync targets.": {
        ...
        es: "Selecciona una configuración remota P2P activa para cambiar los objetivos de sincronización P2P.",
    },
    ...
    "Please select the button below to restart and proceed to the data fetching confirmation.": {
        ...
        es: "Selecciona el botón de abajo para reiniciar y continuar con la confirmación de obtención de datos.",
    },
    "Please select the button below to restart and proceed to the final confirmation.": {
        ...
        es: "Selecciona el botón de abajo para reiniciar y continuar con la confirmación final.",
    },
    ...
    "Please understand that this is intended behaviour.": {
        ...
        es: "Ten en cuenta que este es el comportamiento esperado.",
    },
    "Plug-in version": {
        def: "Plug-in version",
        ja: "プラグインバージョン",
    ...
    "Plugin initialisation was cancelled by a module": {
    ...
    "Prevent fetching configuration from server": {
        ...
        es: "Impedir obtener la configuración desde el servidor",
    },
    Proceed: {
        def: "Proceed",
        es: "Continuar",
    ...
    "Pushing changes to peers — click to stop": {
        def: "Pushing changes to peers — click to stop",
        es: "Enviando cambios a los pares — haz clic para detener",
    },
    "Quick Setup": {
        def: "Quick Setup",
    ...
    "Recommendation to use Setup URI": {
    ...
    "Remote Configuration Check Failed": {
    ...
    "Remote Database Created or Connected": {
    ...
    "Remote database has been marked resolved.": {
    ...
    "Remote storage size exceeded the limit": {
    ...
    "Remote storage size: ${measuredSize}": {
    ...
    "Remote storage size: ${measuredSize} exceeded ${notifySize}": {
    ...
    "Remove sync target": {
        def: "Remove sync target",
        es: "Quitar objetivo de sincronización",
    },
    Rename: {
        def: "Rename",
        es: "Renombrar",
    ...
    "Replication has been cancelled by some module failure": {
    ...
    "Retry with lower batch size:${batch_size}/${batches_limit}": {
    ...
    "Save settings to a markdown file. You will be notified when new settings arrive. You can set different files by the platform.":
        {
            ...
            es: "Guardar los ajustes en un archivo markdown. Se te notificará cuando lleguen nuevos ajustes. Puedes definir archivos distintos según la plataforma.",
    ...
    "Scans for files that are not stored correctly in the database.": {
    ...
    "Select active P2P remote": {
        ...
        es: "Selecciona el remoto P2P activo",
    },
    "Select All Shiny": {
    ...
    "Selecting this option will result in the current data on this device being used to initialise the server. Any existing data on the server will be completely overwritten.":
        {
            ...
            es: "Seleccionar esta opción hará que los datos actuales de este dispositivo se usen para inicializar el servidor. Cualquier dato existente en el servidor se sobrescribirá por completo.",
        },
    "Selecting this option will result in this device joining the existing server. You need to fetching the existing synchronisation data from the server to this device.":
        {
            ...
            es: "Seleccionar esta opción hará que este dispositivo se una al servidor existente. Necesitas obtener los datos de sincronización existentes desde el servidor a este dispositivo.",
        },
    Selective: {
        def: "Selective",
        es: "Selectivo",
    },
    "Self-hosted LiveSync Config Doctor": {
    ...
    "Self-hosted LiveSync v${manifestVersion} ${packageVersion}": {
    ...
    "Send chunks in bulk has been enabled, however, this feature had been corrupted. Sorry for your inconvenience. Automatically disabled.":
        {
            ...
            es: "El envío de fragmentos en bloque se ha habilitado, sin embargo, esta función se ha corrompido. Disculpa las molestias. Desactivado automáticamente.",
    ...
    "Set as sync target": {
        def: "Set as sync target",
        es: "Establecer como objetivo de sincronización",
    },
    ...
    "Set chttpd.require_valid_user = true": {
    ...
    "Set sync target": {
        def: "Set sync target",
        es: "Establecer objetivo de sincronización",
    },
    "Setting Doctor": {
        def: "Setting Doctor",
    ...
    "Setting up database size notification": {
    ...
    "Setup Complete: Preparing to Fetch Synchronisation Data": {
        ...
        es: "Configuración completada: preparando la obtención de datos de sincronización",
    },
    ...
    "Show QR code to transfer the settings.": {
    ...
    "Some file events are pending. Replication has been cancelled.": {
    ...
    "Something happened on Remote Database Destroy:": {
    ...
    "Something went wrong! The local database is not ready": {
    ...
    "Start pushing changes to peers": {
        def: "Start pushing changes to peers",
        es: "Iniciar el envío de cambios a los pares",
    },
    "Start Sync & Close": {
    ...
    "Sync Settings via Markdown": {
        def: "Sync Settings via Markdown",
        es: "Ajustes de sincronización mediante Markdown",
    ...
    "Sync target — click to remove": {
        def: "Sync target — click to remove",
        es: "Objetivo de sincronización — haz clic para quitar",
    },
    ...
    "The configuration stored remotely has been updated.": {
        def: "The configuration stored remotely has been updated.",
    },
    "The connection to the remote has been prevented, or failed.": {
    ...
    "The connection to the server has been configured successfully. As the next step,": {
        ...
        es: "La conexión con el servidor se ha configurado correctamente. Como siguiente paso,",
    },
    ...
    "The device configuration have been adjusted.": {
    ...
    "The Group ID and passphrase are used to identify your group of devices. Make sure to use the same Group ID and passphrase on all devices you want to synchronise.":
        {
            ...
            es: "El ID de grupo y la frase de contraseña se usan para identificar tu grupo de dispositivos. Asegúrate de usar el mismo ID de grupo y frase de contraseña en todos los dispositivos que quieras sincronizar.",
        },
    ...
    "the latest synchronisation data will be downloaded from the server to this device.": {
        ...
        es: "los datos de sincronización más recientes se descargarán desde el servidor a este dispositivo.",
    },
    "the local database, that is to say the synchronisation information, must be reconstituted.": {
        ...
        es: "la base de datos local, es decir, la información de sincronización, debe reconstituirse.",
    },
    ...
    "The remote is already set up, and the configuration is compatible (or got compatible by this operation).": {
        ...
        es: "El remoto ya está configurado, y la configuración es compatible (o se volvió compatible con esta operación).",
    },
    ...
    'The setting "${setting}" was modified from another device. Click {HERE} to reload settings. Click elsewhere to ignore changes.':
        {
            ...
            es: 'El ajuste "${setting}" fue modificado desde otro dispositivo. Haz clic {HERE} para recargar los ajustes. Haz clic en otro lugar para ignorar los cambios.',
    ...
    "The Setup-URI does not appear to be valid. Please check that you have copied it correctly.": {
        ...
        es: "La URI de configuración no parece ser válida. Comprueba que la hayas copiado correctamente.",
    },
    ...
    "the single, authoritative master copy": {
        ...
        es: "la única copia maestra autorizada",
    },
    "the synchronisation data on the server will be built based on the current data on this device.": {
        ...
        es: "los datos de sincronización en el servidor se generarán a partir de los datos actuales de este dispositivo.",
    },
    "The value should ${min} < value < ${max}": {
    ...
    "There may be differences between the files in this Vault and the server.": {
        ...
        es: "Puede que haya diferencias entre los archivos de esta bóveda y los del servidor.",
    },
    "Therefore, we ask that you exercise extreme caution when configuring server information manually. If an incorrect passphrase is entered, the data on the server will become corrupted.":
        {
            ...
            es: "Por ello, te pedimos que tengas extrema precaución al configurar manualmente la información del servidor. Si se introduce una frase de contraseña incorrecta, los datos del servidor se corromperán.",
        },
    "This can isolate your connections between devices. Use the same Room ID for the same devices.": {
        ...
        es: "Esto puede aislar tus conexiones entre dispositivos. Usa el mismo ID de sala para los mismos dispositivos.",
    },
    "This device": {
        def: "This device",
        es: "Este dispositivo",
    ...
    "This feature cannot be used with IBM Cloudant.": {
    ...
    "This is an advanced option for users who do not have a URI or who wish to configure detailed settings. You can also select this option if you intend to use":
        {
            def: "This is an advanced option for users who do not have a URI or who wish to configure detailed settings. You can also select this option if you intend to use",
            es: "Esta es una opción avanzada para usuarios que no tienen una URI o que desean configurar ajustes detallados. También puedes seleccionar esta opción si tienes intención de usar",
        },
    "This is an extremely powerful operation. We strongly recommend that you copy your Vault folder to a safe location.":
        {
            ...
            es: "Esta es una operación extremadamente potente. Te recomendamos encarecidamente que copies la carpeta de tu bóveda a una ubicación segura.",
        },
    ...
    "This procedure will first delete all existing synchronisation data from the server. Following this, the server data will be completely rebuilt, using the current state of your Vault on this device (including its local database) as":
        {
            ...
            es: "Este procedimiento primero eliminará todos los datos de sincronización existentes del servidor. A continuación, los datos del servidor se reconstruirán por completo, usando el estado actual de tu bóveda en este dispositivo (incluyendo su base de datos local) como",
        },
    "This setting must be the same even when connecting to multiple synchronisation destinations.": {
        def: "This setting must be the same even when connecting to multiple synchronisation destinations.",
        es: "Este ajuste debe ser el mismo incluso al conectar con múltiples destinos de sincronización.",
    },
    ...
    "This will rebuild the local database on this device using the most recent data from the server. This action is designed to resolve synchronisation inconsistencies and restore correct functionality.":
        {
            ...
            es: "Esto reconstruirá la base de datos local de este dispositivo usando los datos más recientes del servidor. Esta acción está diseñada para resolver inconsistencias de sincronización y restaurar el funcionamiento correcto.",
        },
    ...
    "Threshold has been enlarged to ${size}MB": {
    ...
    "TURN server settings are only necessary if you are behind a strict NAT or firewall that prevents direct P2P connections. In most cases, you can leave these fields blank.":
        {
            ...
            es: "Los ajustes del servidor TURN solo son necesarios si estás detrás de un NAT o cortafuegos estricto que impida las conexiones P2P directas. En la mayoría de los casos, puedes dejar estos campos en blanco.",
        },
    "TURN Server URLs (comma-separated)": {
        def: "TURN Server URLs (comma-separated)",
        es: "URLs del servidor TURN (separadas por comas)",
    },
    "TURN Username": {
        def: "TURN Username",
        es: "Usuario TURN",
    ...
    "Unless you are certain, selecting this options is bit dangerous. It assumes that the server configuration is compatible with this device. If this is not the case, data loss may occur. Please ensure you know what you are doing.":
        {
            ...
            es: "A menos que estés seguro, seleccionar esta opción es un poco arriesgado. Se asume que la configuración del servidor es compatible con este dispositivo. Si no es el caso, puede producirse pérdida de datos. Asegúrate de saber lo que haces.",
        },
    "Unloading plugin...": {
    ...
    "Unlock remote database to prevent data corruption": {
    ...
    "Update remote database settings": {
    ...
    "Update remote database settings and rebuild again": {
    ...
    "Update remote database settings but keep as is": {
    ...
    "Use Diagnostic RTCPeerConnection for statistics": {
        ...
        es: "Usar RTCPeerConnection de diagnóstico para estadísticas",
    },
    ...
    "Use Path-Style Access": {
        ...
        es: "Usar acceso con estilo de ruta",
    },
    "Use Random Number": {
    ...
    "Using public TURN servers may have privacy implications, as your data will be relayed through third-party servers. Even if your data are encrypted, your existence may be known to them. Please ensure you trust the TURN server provider before using their services. Also your `network administrator` too. You should consider setting up your own TURN server for your FQDN, if possible.":
        {
            def: "Using public TURN servers may have privacy implications, as your data will be relayed through third-party servers. Even if your data are encrypted, your existence may be known to them. Please ensure you trust the TURN server provider before using their services. Also your `network administrator` too. You should consider setting up your own TURN server for your FQDN, if possible.",
            es: "Usar servidores TURN públicos puede tener implicaciones de privacidad, ya que tus datos se retransmitirán a través de servidores de terceros. Aunque tus datos estén cifrados, tu existencia puede quedar expuesta ante ellos. Asegúrate de confiar en el proveedor del servidor TURN antes de usar sus servicios. Y también en tu `administrador de red`. Deberías considerar configurar tu propio servidor TURN para tu FQDN, si es posible.",
        },
    "Vault history": {
        def: "Vault history",
        es: "Historial de la bóveda",
    },
    "Verbose Log": {
        def: "Verbose Log",
    ...
    "Watch this peer's changes": {
        def: "Watch this peer's changes",
        es: "Vigilar los cambios de este par",
    },
    "Watching this peer — click to stop": {
        def: "Watching this peer — click to stop",
        es: "Vigilando este par — haz clic para detener",
    },
    ...
    "We can't replicate more lower value.": {
    ...
    "We cannot change the device name while this feature is enabled. Please disable this feature to change the device name.":
        {
            def: "We cannot change the device name while this feature is enabled. Please disable this feature to change the device name.",
            es: "No podemos cambiar el nombre del dispositivo mientras esta función esté habilitada. Desactiva la función para cambiarlo.",
    ...
    "We could not continue the test.": {
    ...
    "We left some issues as is. Shall I ask you again on next startup?": {
    ...
    "We recommend that you copy your Vault folder to a safe location. This will provide a safeguard in case a large number of conflicts arise, or if you accidentally synchronise with an incorrect destination.":
        {
            ...
            es: "Te recomendamos que copies la carpeta de tu bóveda a una ubicación segura. Esto servirá como salvaguarda en caso de que surjan numerosos conflictos, o si sincronizas accidentalmente con un destino incorrecto.",
        },
    "We strongly recommend to treat this as soon as possible!": {
    ...
    "You cannot enable encryption without a passphrase": {
    ...
    "You cannot use capital letters, spaces, or special characters in the database name. And not allowed to start with an underscore (_).":
        {
            def: "You cannot use capital letters, spaces, or special characters in the database name. And not allowed to start with an underscore (_).",
            es: "No puedes usar mayúsculas, espacios ni caracteres especiales en el nombre de la base de datos. Tampoco puede empezar con un guion bajo (_).",
        },
    "You should create a new synchronisation destination and rebuild your data there.": {
        ...
        es: "Deberías crear un nuevo destino de sincronización y reconstruir tus datos allí.",
    },
    "You should perform this operation only in exceptional circumstances, such as when the server data is completely corrupted, when changes on all other devices are no longer needed, or when the database size has become unusually large in comparison to the Vault size.":
        {
            ...
            es: "Deberías realizar esta operación solo en circunstancias excepcionales, como cuando los datos del servidor están completamente corruptos, cuando los cambios en los demás dispositivos ya no son necesarios, o cuando el tamaño de la base de datos se ha vuelto inusualmente grande en comparación con el tamaño de la bóveda.",
        },
    "Your ${title} has been copied to the clipboard.": {
        def: "Your ${title} has been copied to the clipboard.",
        es: "Tu ${title} se ha copiado al portapapeles.",
    },
    "Your ${title} is ready to be copied": {
        def: "Your ${title} is ready to be copied",
        es: "Tu ${title} está listo para copiarse",
    },
    "Your device does not support encryption.": {
    ...
    "Your settings seem correct, but no other peers were found.": {
        def: "Your settings seem correct, but no other peers were found.",
        es: "Tus ajustes parecen correctos, pero no se encontraron otros pares.",
    },
    ...
    "Setup.Please enable 'Compute revisions for chunks' in settings to use Garbage Collection.": {
        es: 'Habilita "Compute revisions for chunks" en los ajustes para usar la recolección de basura.',
    },
