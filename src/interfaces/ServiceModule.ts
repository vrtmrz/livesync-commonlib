...
import type { ServiceHub } from "@/lib/src/services/ServiceHub";
...
export type ServiceFeatureFunction<T extends keyof ServiceHub, U extends keyof ServiceModules, TR> = (
    host: NecessaryServices<T, U>
) => TR;
type ServiceFeatureContext<T> = T & {
    _log: LogFunction;
};
export type ServiceFeatureFunctionWithContext<T extends keyof ServiceHub, U extends keyof ServiceModules, C, TR> = (
    host: NecessaryServices<T, U>,
...
type ContextFactory<T extends keyof ServiceHub, U extends keyof ServiceModules, C> = (
    host: NecessaryServices<T, U>
) => ServiceFeatureContext<C>;

export function serviceFeature<T extends keyof ServiceHub, U extends keyof ServiceModules>() {
    return {
